...
for name in namelist:
    ...
    with open(os.path.join('txt_rep_32_finetune',name+'.txt'), "r", encoding="utf-8") as f:
        content = f.read()
...
with open(os.path.join('im_data_obj_sort_new_32_finetune_final','training_set_'+str(args.ind)+'_randompart.json'), 'w') as json_file:
